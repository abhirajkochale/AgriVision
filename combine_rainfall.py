...
RAINFALL_DIR = DATASET_DIR / "Rainfall"
...
EXPECTED_FILES = [
    "AgriVision_Maharashtra_Rainfall_2017_W1_W26.csv",
    "AgriVision_Maharashtra_Rainfall_2017_W27_W52.csv",

    "AgriVision_Maharashtra_Rainfall_2018_W1_W26.csv",
    "AgriVision_Maharashtra_Rainfall_2018_W27_W52.csv",

    "AgriVision_Maharashtra_Rainfall_2019_W1_W26.csv",
    "AgriVision_Maharashtra_Rainfall_2019_W27_W52.csv",

    "AgriVision_Maharashtra_Rainfall_2020_W1_W26.csv",
    "AgriVision_Maharashtra_Rainfall_2020_W27_W52.csv",
...
# Six decimal places removes meaningless floating-point
# precision differences between independently generated CSVs.
...
if unique_points == 167:
    ...
    raise ValueError(
        f"Expected 167 points but found {unique_points}"
    )
...
if unique_weeks == 468:
    ...
    raise ValueError(
        f"Expected 468 weeks but found {unique_weeks}"
    )
...
if (
    invalid_rainfall == 0
    and wrong_chirps_days == 0
    and negative_rainfall == 0
):

    print(
        "PASS - All rainfall records are valid"
    )
...
if len(bad_points) == 0:
    ...
    print(
        f"FAIL - {len(bad_points)} points have "
    ...
    raise ValueError(
        "Metadata inconsistencies remain. "
        "Rainfall master was not created."
    )
...
print()
print("Rainfall source:")
print(
    master["rainfall_source"]
    .value_counts()
    .to_string()
)
...
print()
print("=" * 70)
print("RAINFALL MASTER DATASET CREATED SUCCESSFULLY")
print("=" * 70)
